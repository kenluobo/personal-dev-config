...
HEADLINE_STYLE_USER=$bold$white
HEADLINE_STYLE_HOST=$bold$yellow
HEADLINE_STYLE_PATH=$bold$cyan
HEADLINE_STYLE_BRANCH=$bold$red
...
HEADLINE_ERR_PREFIX='→ '
HEADLINE_STYLE_ERR=$italic$faint$red
...
headline_git_branch() {
  ...
  if [[ $ret == 0 ]]; then
    ...
    ref=$(headline_git describe --abbrev=0 --tags 2> /dev/null) || return
